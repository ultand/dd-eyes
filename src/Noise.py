...
class Noise:
    ...
    :ivar signal: The noiseless signal generated by :class:`Signal.Signal`
    :vartype signal: np.ndarray
    :ivar snr: Signal-to-Noise ratio in dB
    :vartype snr: float
    :ivar noise: The simulated noise associated with the provided signal. Read-only variable
    :vartype noise: np.ndarray
    """
    def __init__(self, config:dict = None):
        ...
        snr should be a float descrbing the Signal-to-Noise ratio in dB.

        :param config: dictionary containing the 'signal' and 'snr' initial value. Both values default to None. If no values are provided setting the snr and signal seperately will generate the noise., defaults to None
